# Audio Rename Script - Updated for actual files
...
# Updated rename mapping based on actual files
$renameMap = @{
    # Background Music (actual names)
    "bgsnd-mainmenu.mp3" = "bg-menu.mp3"
    "bgsnd-complete.mp3" = "bg-calm.mp3"
    "bgsnd-.mp3" = "bg-tense.mp3"
...
if ($DryRun) {
    ...
    Write-Host "  .\rename-audio-fixed.ps1 -Backup" -ForegroundColor White
} else {
...
Write-Host "`nYou need to manually rename these based on your chapter 4 structure." -ForegroundColor Yellow

Write-Host "`nUsage:" -ForegroundColor White
Write-Host "  .\rename-audio-fixed.ps1              # Rename all files" -ForegroundColor Gray
Write-Host "  .\rename-audio-fixed.ps1 -DryRun      # Preview only" -ForegroundColor Gray
Write-Host "  .\rename-audio-fixed.ps1 -Backup      # With backup" -ForegroundColor Gray
Write-Host ""
